...
const todoRouteHandler = require('../../components/todo/todo.route-handler')
...
const userRouteHandler = require('../../components/users/user.route-handler')
...
container
    ...
    .register({
        ...
        todoRouteHandler: asFunction(todoRouteHandler).singleton(),
    ...
    .register({
        ...
        userRouteHandler: asFunction(userRouteHandler).singleton(),
